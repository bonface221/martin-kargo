...
class Image(models.Model):
    ...
    squareImage = cloudinary.CloudinaryImage(
        'default_square.jpg').build_url(width=1000, height=1000, crop="fill")
    landImage = cloudinary.CloudinaryImage('default_land.jpg').build_url(
        width=2878, height=1618, crop="fill")
    tallImage = cloudinary.CloudinaryImage('default_tall.jpg').build_url(
